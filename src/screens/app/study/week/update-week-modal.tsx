...
export default function UpdateWeekModal({onCloseModal, studyWeek}:ComponentProps) {
  ...
  const [scriptures, setScriptures] = useState<Scripture[]>(studyWeek.scriptures ||  [{ scripture: '', content: '' }]);
  const [mainPoints, setMainPoints] = useState<MainPoint[]>(studyWeek.main_points || [{ title: '', text: '', points: [] }]);
